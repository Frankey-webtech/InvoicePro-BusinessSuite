...
const TEMPLATE_TYPE = "estimate";
const TEMPLATE_LABEL = "estimate";
const TARGET_TEMPLATE_TYPE = "invoice";
const TARGET_TEMPLATE_LABEL = "invoice";
const TEMPLATE_SAVE_FUNCTION = "saveEstimateTemplate";
const TEMPLATE_GET_FUNCTION = "getEstimateTemplate";
const TEMPLATE_RESET_FUNCTION = "resetEstimateTemplate";
const TEMPLATE_TRANSFER_KEY = "invoicepro_template_transfer_v1";
const TARGET_TEMPLATE_URL = "invoices-design.html";
...
const sections = [
    ...
    {button:"invoiceDetailsButton",section:"invoiceDetailsSelection",badge:"invoiceDetailsBadge",title:"Editing Estimate Details"},
